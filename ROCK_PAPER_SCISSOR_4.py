...
class RockPaperScissors:
    def __init__(self):
        ...
        self.title_label = tk.Label(self.window, text="Rock-Paper-Scissors Game", font=("Arial", 18, "bold"), bg="#f0f0f0")
        self.title_label.pack(pady=10)

        self.user_choice_label = tk.Label(self.window, text="Your Choice:", font=("Arial", 14), bg="#f0f0f0")
        self.user_choice_label.pack(pady=5)

        self.computer_choice_label = tk.Label(self.window, text="Computer's Choice:", font=("Arial", 14), bg="#f0f0f0")
        self.computer_choice_label.pack(pady=5)

        self.result_label = tk.Label(self.window, text="", font=("Arial", 14, "bold"), bg="#f0f0f0")
        self.result_label.pack(pady=10)

        self.score_label = tk.Label(self.window, text=f"Score: You - {self.user_score}, Computer - {self.computer_score}", font=("Arial", 14), bg="#f0f0f0")
        ...
        self.scissors_button = tk.Button(self.button_frame, image=self.scissors_image, command=lambda: self.play("scissors"))
        self.scissors_button.grid(row=0, column=2, padx=5)

        self.play_again_button = tk.Button(self.window, text="Play Again", font=("Arial", 14, "bold"), bg="green", fg="white", command=self.play_again)
